...
$ repo init -u https://github.com/GitUi/manifest -b a1
...
# For example, enter GitUi/android_frameworks_base or
# frameworks/base to sync the frameworks/base repository

$ repo sync PROJECT
Building
The bundled builder tool ./rom-build.sh handles all the building steps for the specified device automatically. As the device value, you just feed it with the device codename (for example, 'surya' for the Pocophone X3).
...
# For example, `repo start fix-clock GitUi/android_frameworks_base`
$ repo start BRANCH GITUI/PROJECT
...
# the GitUi Github.  For example, android_frameworks_base translates
...
# Upload your changes
$ git push ssh://USERNAME@gerrit.gitui.co:29418/GitUi/PROJECT HEAD:refs/for/a1
Extra commands for Gerrit
# If you desire to upload a change as private use the below command
$ git push ssh://USERNAME@gerrit.gitui.co:29418/GitUi/PROJECT HEAD:refs/for/a1%private

# If you desire to upload a change as W.I.P(Work in Progress) use the below command
$ git push ssh://USERNAME@gerrit.gitui.co:29418/GitUi/PROJECT HEAD:refs/for/a1%wip

# After that, if you want to make the commit public you can use the UI tools on GitUi Gerrit website, or use the below command
$ git push ssh://USERNAME@gerrit.gitui.co:29418/GitUi/PROJECT HEAD:refs/for/a1%remove-private

# If you want to unset the W.I.P status on your commit, you can use UI tools on GitUi Gerrit website, or use the below command
$ git push ssh://USERNAME@gerrit.gitui.co:29418/GitUi/PROJECT HEAD:refs/for/a1%ready
